...
-Takes in textual or photographic (png) input and predicts the input's language in two ways: either through Java code with analysis and cosine similarity score comparisons 
or by being fed through the Gemini API. 
